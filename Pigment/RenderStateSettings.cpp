...
RenderStateSettings::RenderStateSettings() : m_renderState(0)
{
    // set more defaults
...
RenderStateSettings & RenderStateSettings::setBlendFunction(BlendFunction _srcFunc,
                                                            BlendFunction _destFunc)
{
    return setBlendFunction(_srcFunc, _destFunc, _srcFunc, _destFunc);
}

RenderStateSettings & RenderStateSettings::setBlendFunction(BlendFunction _colorSrcFunc,
                                                            BlendFunction _colorDestFunc,
                                                            BlendFunction _alphaSrcFunc,
                                                            BlendFunction _alphaDestFunc)
{
...
RenderStateSettings & RenderStateSettings::setStencilFunction(CompareFunction _func,
                                                              Int32 _ref,
                                                              UInt32 _mask)
{
...
RenderStateSettings & RenderStateSettings::setStencilFunction(FaceType _face,
...
RenderStateSettings & RenderStateSettings::setStencilOperation(StencilOperation _sfail,
                                                               StencilOperation _dpfail,
                                                               StencilOperation _dppass)
{
...
RenderStateSettings & RenderStateSettings::setStencilOperation(FaceType _face,
...
{
    return stencilField<StencilOperation>(SF_StencilOpSFailFrontFaceShift,
                                          SF_StencilOpSFailFrontFaceMask);
}

StencilOperation RenderStateSettings::stencilDPFailOperationFrontFace() const
{
    return stencilField<StencilOperation>(SF_StencilOpDPFailFrontFaceShift,
                                          SF_StencilOpDPFailFrontFaceMask);
}

StencilOperation RenderStateSettings::stencilDPPassOperationFrontFace() const
{
    return stencilField<StencilOperation>(SF_StencilOpDPPassFrontFaceShift,
                                          SF_StencilOpDPPassFrontFaceMask);
}

StencilOperation RenderStateSettings::stencilSFailOperationBackFace() const
{
    return stencilField<StencilOperation>(SF_StencilOpDPFailBackFaceShift,
...
{
    return stencilField<StencilOperation>(SF_StencilOpDPPassBackFaceShift,
