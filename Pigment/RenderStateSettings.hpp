...
class STICK_API RenderStateSettings
{
  public:
    ...
    RenderStateSettings & setBlendFunction(BlendFunction _colorSrcFunc,
    ...
    RenderStateSettings & setStencilFunction(CompareFunction _func,
                                             stick::Int32 _ref,
                                             stick::UInt32 _mask);

    RenderStateSettings & setStencilFunction(FaceType _face,
                                             CompareFunction _func,
                                             stick::Int32 _ref,
                                             stick::UInt32 _mask);

    RenderStateSettings & setStencilOperation(StencilOperation _sfail,
                                              StencilOperation _dpfail,
                                              StencilOperation _dppass);

    RenderStateSettings & setStencilOperation(FaceType _face,
