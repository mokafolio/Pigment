...
void CommandBuffer::loadPixelsRaw(const TextureHandle & _handle,
                                  Size _width,
                                  Size _height,
                                  Size _depth,
                                  void * _pixels,
...
{
    m_pimpl->loadPixelsRaw(
        _handle, _width, _height, _depth, _pixels, _dataType, _format, _mipmapLevelCount);
}

void CommandBuffer::allocatePixels(const TextureHandle & _handle,
                                   Size _width,
                                   Size _height,
                                   Size _depth,
                                   TextureFormat _format,
...
{
    loadPixelsRaw(
        _handle, _width, _height, 1, nullptr, PixelDataType::UInt8, _format, _mipmapLevelCount);
}
...
void CommandBuffer::updatePixelsRaw(const TextureHandle & _handle,
                                    Size _x,
                                    Size _y,
                                    Size _z,
                                    Size _width,
...
void CommandBuffer::setProgramVariable(const ProgramHandle & _program,
                                       const String & _name,
...
void CommandBuffer::setProgramVariablef(const ProgramHandle & _program,
                                        const String & _name,
                                        Float32 _a)
{
...
void CommandBuffer::setProgramVariablef(
...
void CommandBuffer::setProgramVariableMatrix3f(const ProgramHandle & _program,
                                               const String & _name,
                                               Float32 * _ptr)
{
    ProgramVariableValue v;
...
void CommandBuffer::setProgramVariableMatrix4f(const ProgramHandle & _program,
                                               const String & _name,
                                               Float32 * _ptr)
{
    ProgramVariableValue v;
...
void CommandBuffer::attachTexture(const ProgramHandle & _program,
                                  const String & _name,
...
void CommandBuffer::loadVertexDataRaw(const VertexBufferHandle & _handle,
                                      Size _byteCount,
...
void CommandBuffer::updateVertexDataRaw(const VertexBufferHandle & _handle,
                                        Size _byteOffset,
                                        Size _byteCount,
                                        const void * _dataSource)
{
...
void CommandBuffer::loadIndexDataRaw(const IndexBufferHandle & _handle,
                                     Size _byteCount,
                                     const void * _dataSource)
{
...
void CommandBuffer::updateIndexDataRaw(const IndexBufferHandle & _handle,
                                       Size _byteOffset,
                                       Size _byteCount,
                                       const void * _dataSource)
{
...
void CommandBuffer::draw(const RenderStateHandle & _renderState,
...
{
    m_pimpl->draw(
        _renderState, _program, _mesh, _mode, _vertexOffset, _vertexCount, _instanceCount);
}
