...
class STICK_API CommandBuffer
{
  ...
  public:
    ...
    void loadPixelsRaw(const TextureHandle & _handle,
                       stick::Size _width,
                       stick::Size _height,
                       stick::Size _depth,
                       void * _pixels,
                       ...
                       stick::UInt32 _mipmapLevelCount = 0);

    void allocatePixels(const TextureHandle & _handle,
                        stick::Size _width,
                        stick::Size _height,
                        stick::Size _depth,
                        TextureFormat _format,
    ...
    void updatePixelsRaw(const TextureHandle & _handle,
                         stick::Size _x,
                         stick::Size _y,
                         stick::Size _z,
                         stick::Size _width,
    ...
    void setProgramVariable(const ProgramHandle & _program,
                            const stick::String & _name,
                            const ProgramVariableValue & _val);

    void setProgramVariablef(const ProgramHandle & _program,
                             const stick::String & _name,
                             stick::Float32 _a);
    ...
    void setProgramVariableMatrix3f(const ProgramHandle & _program,
                                    const stick::String & _name,
                                    stick::Float32 * _ptr);

    void setProgramVariableMatrix4f(const ProgramHandle & _program,
                                    const stick::String & _name,
                                    stick::Float32 * _ptr);

    void attachTexture(const ProgramHandle & _program,
                       const stick::String & _name,
    ...
    void loadVertexDataRaw(const VertexBufferHandle & _handle,
                           stick::Size _byteCount,
                           const void * _dataSource);

    template <class T>
    void loadVertexData(const VertexBufferHandle & _handle,
    ...
    void updateVertexDataRaw(const VertexBufferHandle & _handle,
                             stick::Size _byteOffset,
                             stick::Size _byteCount,
                             const void * _dataSource);

    template <class T>
    void updateVertexData(const VertexBufferHandle & _handle,
                          stick::Size _elementOffset,
                          stick::Size _elementCount,
                          const T * _dataSource)
    {
        updateVertexDataRaw(
            _handle, sizeof(T) * _elementOffset, sizeof(T) * _elementCount, _dataSource);
    }

    void loadIndexDataRaw(const IndexBufferHandle & _handle,
                          stick::Size _byteCount,
                          const void * _dataSource);

    template <class T>
    void loadIndexData(const IndexBufferHandle & _handle,
                       stick::Size _elementCount,
                       const T * _dataSource)
    {
    ...
    void updateIndexDataRaw(const IndexBufferHandle & _handle,
                            stick::Size _byteOffset,
                            stick::Size _byteCount,
                            const void * _dataSource);

    template <class T>
    void updateIndexData(const IndexBufferHandle & _handle,
                         stick::Size _elementOffset,
                         stick::Size _elementCount,
                         const T * _dataSource)
    {
    ...
    void setViewport(stick::Float32 _x,
                     stick::Float32 _y,
                     stick::Float32 _width,
                     stick::Float32 _height);

    void draw(const RenderStateHandle & _renderState,
              const ProgramHandle & _program,
              const MeshHandle & _mesh,
              VertexDrawMode _mode,
              stick::Size _vertexOffset,
              stick::Size _vertexCount,
              stick::Size _instanceCount = 1);
