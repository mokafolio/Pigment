...
BufferLayout::BufferLayout(Allocator & _alloc) : m_elements(_alloc)
{
}
...
BufferLayout & BufferLayout::addElement(const String & _name,
                                        Size _elementCount,
                                        BufferDataType _dataType)
{
    m_elements.append(
        BufferElement(_elementCount, 0, _name, _dataType, (UInt32)m_elements.count(), 0));
    return *this;
}
