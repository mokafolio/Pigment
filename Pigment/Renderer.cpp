...
RenderBuffer::RenderBuffer(const RenderBufferHandle & _handle,
                           const TextureHandleArray & _colorTargets,
                           const TextureHandle & _depthTarget) :
    m_handle(_handle),
...
void Renderer::destroyRenderBuffer(const RenderBufferHandle & _renderBufferHandle,
...
VertexBufferHandleResult Renderer::createVertexBuffer(const VertexLayout & _layout,
                                                      BufferUsage _usage)
{
